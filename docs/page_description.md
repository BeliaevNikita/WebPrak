...
![Фильтрация каталога](docs/catalog_filtered.png)
...
![Личный кабинет](docs/user_info.png)
...
![Панель управления](docs/emp_main.png)
...
![Управление книгами](docs/emp_books_manage.png)
...
![Управление заказами](docs/emp_orders_manage.png)
...
![Возврат заказа](docs/emp_refund.png)
